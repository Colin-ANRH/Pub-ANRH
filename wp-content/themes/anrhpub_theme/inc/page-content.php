...
define( 'ANRHPUB_CONTENT_VERSION', 4 );

/**
 * Contenu HTML — page Notre activité (/societe/) — sync éditeur / SEO.
 *
 * @return string
 */
function anrhpub_societe_page_content() {
	...
	<section class="societe-section">
		...
		<p><?php esc_html_e( 'Notre activité est dédiée aux professionnels, entreprises, collectivités et associations.', 'anrhpub_theme' ); ?></p>
	...
	<section class="societe-section">
		...
		<p><?php esc_html_e( 'Vous trouverez des produits allant du plus classique (stylos, blocs-notes, tasses, t-shirts…) au plus original et hi-tech (diffuseurs, lampes, réveils, accessoires de cuisine, chargeurs solaires…).', 'anrhpub_theme' ); ?></p>
		<p><?php esc_html_e( 'Notre entreprise adaptée vous propose une personnalisation à votre image pour vos communications B to B : évènements, cadeaux CSE ou cadeaux clients.', 'anrhpub_theme' ); ?></p>
	</section>

	<aside class="societe-highlight">
